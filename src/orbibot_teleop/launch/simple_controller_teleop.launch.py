#!/usr/bin/env python3
"""
Simple Controller Teleop Launch File for OrbiBot
"""
...
def generate_launch_description():
    """Generate launch description for simple controller teleop"""
    ...
    # Simple controller teleop node
    simple_controller_teleop_node = Node(
        package='orbibot_teleop',
        executable='simple_controller_teleop',
        name='simple_controller_teleop',
        output='screen',
        parameters=[{
